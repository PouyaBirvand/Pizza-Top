...
function NavigationItem({ to, label, icon, isMobile = false, onClick }) {
  const baseClasses = "text-slate-700 dark:text-slate-300 hover:text-emerald-600 dark:hover:text-emerald-400 font-medium transition-colors duration-200 flex items-center space-x-2";
